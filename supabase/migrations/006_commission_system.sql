...
CREATE TABLE public.commission_formula_config (
  ...
  pct_fee_energia   NUMERIC(5,2) NOT NULL DEFAULT 100,
  fee_potencia      NUMERIC(10,6) NOT NULL DEFAULT 0,
  pct_fee_potencia  NUMERIC(5,2) NOT NULL DEFAULT 100,
  comision_servicio NUMERIC(10,4) NOT NULL DEFAULT 0,
...
CREATE TABLE public.commission_calculations (
  ...
  pct_fee_energia_used   NUMERIC(5,2),
  fee_potencia_used      NUMERIC(10,6),
  pct_fee_potencia_used  NUMERIC(5,2),
  comision_servicio_used NUMERIC(10,4),
